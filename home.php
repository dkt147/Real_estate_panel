        ...
        <div class="row">
                <?php while($rows = mysqli_fetch_assoc($result)){ ?>
                    ...
                    <div class="card" style="width: 25rem;height: 27rem;padding: 1px" >
                        <img class="card-img-top" src="imgs/1.jpg" alt="Card image cap" style="border-radius:border-radius: 20px;" onclick="window.location='property.php?id=<?php echo $rows['id']?>'">
                        <button class="btn btn-default">$ <?php echo sprintf("%.2f",$rows['price'])?>
                        </button>
                        <i class="fa fa-trash" style="color: red;transform: translate(366px, -239px);" onclick="deleteProperty(<?php echo $rows['id']?>)"></i>
