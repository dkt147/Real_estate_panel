...
<div class="container">
    ...
    padding-top: 18px;">
        ...
        <table class="table">
            ...
            <tbody>
            <?php
                $query = "select offers.*,property.*,users.*,users.id as uu_id,property.id as pp_id FROM offers JOIN property on property.id = offers.p_id JOIN users on users.id = offers.user_id";
            ...
            while($row = mysqli_fetch_assoc($result)){
                ?>
                <tr>
                    <th><input type="checkbox" name="checkbox" value="<?php echo $row['id'];?>" id="checkbox"></th>
