...
<!--                </div>-->
            ...
            <div class="row nav py-5" style="">
                <nav>
                    <ul>
                        ...
                        <li><a href="docs.php?id=<?php echo $_GET['id'];?>" style="
            color: #4962db;
    ...
    padding-top: 18px;">
                <div class="col-md-6"><h4 style="margin-top: 5px;font-size: 30px">Docs</h4></div>
                ...
                <div class="container">
                    <form action="_update_property.php" method="POST" enctype="multipart/form-data">
                        ...
                        while($rowd = mysqli_fetch_assoc($resultd)){?>
                                <a download="<?php echo $rowd['file'];?>" href="<?php echo $rowd['file'];?>">
                        <div class="row">
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="first"><img src="imgs/pdf.jpeg" class="img-responsive" style="height:40px!important"></label>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="first" style="margin-top: 20px"> Closing</label>
                                </div>
                            </div>
                            <!--  col-md-6   -->
